...
var LangIt_Delay = 50 //·­ÒëÑÓÊ±ºÁÃë£¨ÉèÕâ¸öµÄÄ¿µÄÊÇÈÃÍøÒ³ÏÈÁ÷³©µÄÏÔÏÖ³öÀ´£©

var intvLang=setInterval(function(){
	
	if(document.readyState=="complete"){
	   if(isFT()){
	       LangBody();
	   }
		clearInterval(intvLang);
	}
},LangIt_Delay);
